...
copy_file "$SRC/Finora-1.1.0-arm64.dmg"       "Finora-1.1.0-arm64.dmg"
copy_file "$SRC/Finora Setup 1.1.0.exe"        "Finora.Setup.1.1.0.exe"
copy_file "$SRC/Finora-1.1.0.AppImage"         "Finora-1.1.0.AppImage"
